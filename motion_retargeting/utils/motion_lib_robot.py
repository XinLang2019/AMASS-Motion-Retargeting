...
from motion_retargeting.utils.motion_lib_base import MotionLibBase, DeviceCache, compute_motion_dof_vels, FixHeightMode
...
class MotionLibRobot(MotionLibBase):
    ...
    def __init__(self, robot_type, motion_file, device, fix_height=FixHeightMode.no_fix, masterfoot_conifg=None, min_length=-1, im_eval=False, multi_thread=True, extend_hand = True, extend_head = False, mjcf_file="resources/robots/g1/g1_23dof_rev_1_0.xml", sim_timestep = 1/50):
        ...
        self.mesh_parsers = Humanoid_Batch(extend_hand = extend_hand, extend_head = extend_head, mjcf_file=mjcf_file, robot_type=robot_type)
        return
